...
<div class="am-panel am-panel-default news-nav-list block-box">
	...
	<ul class="am-list">
		...
		<li><a href="<?php echo $value['url'];?>" title="<?php echo $value['title'];?>"<?php if($cid == $value['id']){ ?> class="am-active"<?php } ?>> <?php echo $value['title'];?></a></li>
			...
			<li><a href="<?php echo $v['url'];?>" title="<?php echo $v['title'];?>"<?php if($cid == $v['id']){ ?> class="am-active"<?php } ?> style="padding-left:2em;"> <?php echo $v['title'];?></a></li>
			<?php } ?>
			<?php } ?>
		<?php } ?>
	</ul>
